...
{
	ipf::IPv4 def;
	ASSERT_EQ(std::byte(127), def[0]);
	ASSERT_EQ(std::byte(0), def[1]);
	ASSERT_EQ(std::byte(0), def[2]);
	ASSERT_EQ(std::byte(1), def[3]);
}

TEST(IPv4Test, constructor_const_char_ptr)
{
    ipf::IPv4 def{ "1.2.3.4" };
    ASSERT_EQ(std::byte(1), def[0]);
    ASSERT_EQ(std::byte(2), def[1]);
    ASSERT_EQ(std::byte(3), def[2]);
    ASSERT_EQ(std::byte(4), def[3]);
}
...
{
    ipf::IPv4 def{ std::byte(1), std::byte(2), std::byte(3), std::byte(4) };
    ASSERT_EQ(std::byte(1), def[0]);
    ASSERT_EQ(std::byte(2), def[1]);
    ASSERT_EQ(std::byte(3), def[2]);
    ASSERT_EQ(std::byte(4), def[3]);
...
TEST(IPv4Test, constructor_copy)
{
    ipf::IPv4 def{ 1, 2, 3, 4 };
    ipf::IPv4 copy{ def };
    ASSERT_EQ(std::byte(1), copy[0]);
    ASSERT_EQ(std::byte(2), copy[1]);
    ASSERT_EQ(std::byte(3), copy[2]);
    ASSERT_EQ(std::byte(4), copy[3]);
}
...
TEST(IPv4Test, constructor_move)
{
    ...
    ASSERT_EQ(std::byte(1), moved[0]);
    ASSERT_EQ(std::byte(2), moved[1]);
    ASSERT_EQ(std::byte(3), moved[2]);
    ASSERT_EQ(std::byte(4), moved[3]);
}
